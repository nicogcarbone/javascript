  ...
  `);
        ...
        $(`#sumarPuntos${e.id}`).on("click", () => {
          ...
          if (torneo[index].puntos > 30) {
            $(".tabla").prepend(
              `<h1 id="campeon" style="display-none">¡FELICITACIONES CAMPEON!</h1>`
            );
            $("#campeon").css({
              color: "white",
              "font-size": "100px",
    ...
    $("#myForm").submit(function (e) {
      ...
      alert(
        "BIENVENIDO" +
          ...
          local +
          " " +
          " \n UNA VEZ AGREGADO TU EQUIPO A LA TABLE AGREGA LOS PUNTOS QUE CREAS NECESARIO"
      );
